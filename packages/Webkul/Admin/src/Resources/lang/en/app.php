...
return [
    'users' => [
        'sessions' => [
            ...
            'password' => 'Password',
            'powered-by-description' => 'Powered by KeynoStore by KeynoTech',
            'submit-btn' => 'Sign In',
            'title' => 'Sign In',
        ],
    ...
    'appearance' => [
        ...
        'sections' => [
            ...
            'edit' => [
                ...
                'custom-html' => 'Custom HTML',
                'custom-html-description' => 'Add isolated, self-contained custom HTML, CSS, and JavaScript directly.',
                'status' => 'Status',
                'themes' => 'Themes',
                'title' => 'Edit Section',
        ...
        'index' => [
            ...
            'sales' => [
                ...
                'payment-methods' => [
                    ...
                    'title' => 'Title',
                    'utap' => 'uTap by e&',
                    'utap-client-code' => 'Client Code',
                    'utap-client-code-info' => 'Optional. Add the uTap client code if your merchant account requires it.',
                    'utap-cust-code' => 'Customer Code',
                    'utap-cust-code-info' => 'Merchant customer code used when creating payment links in uTap.',
                    'utap-cust-group-cust-code' => 'Customer Group Code',
                    'utap-cust-group-cust-code-info' => 'Optional fallback group customer code if your uTap setup uses it.',
                    'utap-info' => 'Configure the hosted uTap by e& (Mswipe) payment-link checkout used across Keyno platforms.',
                    'utap-link-validity' => 'Link Validity (Minutes)',
                    'utap-link-validity-info' => 'How long the hosted payment link stays valid after checkout starts.',
                    'utap-ref-id' => 'Reference ID',
                    'utap-ref-id-info' => 'Optional. If left blank, the gateway will fall back to the configured user name.',
                    'utap-sandbox-info' => 'Send payments to the uTap UAT environment instead of live.',
                    'utap-user-name' => 'User Name',
                    'utap-user-name-info' => 'Your uTap / Mswipe API user name.',
                    'utap-user-pwd' => 'User Password',
                    'utap-user-pwd-info' => 'Your uTap / Mswipe API password.',
                ],
    ...
    'components' => [
        'layouts' => [
            ...
            'powered-by' => [
                'description' => 'Powered by KeynoStore by KeynoTech',
            ],
        ],
    ...
    'footer' => [
        'copy-right' => 'Powered by KeynoStore by KeynoTech',
    ],
