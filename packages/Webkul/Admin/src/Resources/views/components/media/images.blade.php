            ...
            <div class="flex flex-wrap gap-1">
                ...
                <template v-if="allowMultiple || images.length == 0">
                    ...
                    <label
                        ...
                        :class="[hasErrors() ? 'border border-red-500' : 'border-gray-300']"
                        :style="{'max-width': this.width, 'max-height': this.height}"
                        :for="$.uid + '_imageInput'"
                    >
                        <div class="flex flex-col items-center">
    ...
    <script type="module">
        app.component('v-media-images', {
            ...
            methods: {
                ...
                hasErrors() {
                    return Object.keys(this.errors || {}).some(key => key === this.errorKeyPrefix || key.startsWith(this.errorKeyPrefix + '.'));
                },
