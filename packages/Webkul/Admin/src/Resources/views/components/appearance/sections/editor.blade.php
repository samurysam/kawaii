        ...
        app.component('v-section-editor', {
                ...
                return {
                    ...
                    sectionTypes: [
                        ...
                        },
                        {
                            key: 'custom_html',
                            icon: 'icon-cms',
                            label: "@lang('admin::app.appearance.sections.create.type.custom-html')",
                        },
                    ],
                };
            },
            ...
            methods: {
                ...
                reloadPreview() {
                    ...
                    const freshPreviewUrl = `${this.previewUrl}${separator}_preview=${Date.now()}`;

                    try {
                        this.$refs.preview.src = freshPreviewUrl;
                    } catch (error) {
                        this.$refs.preview.src = freshPreviewUrl;
                    }
                },
