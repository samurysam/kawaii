...
<body class="h-full kb-admin-shell dark:bg-[#4b2f3b]">
    ...
    >
        ...
        >
            ...
            <div class="flex min-h-[calc(100vh-62px)] max-w-full flex-1 flex-col bg-transparent transition-all duration-300 pt-3 px-2 sm:px-4 lg:pt-3 lg:px-4 lg:ltr:pl-[286px] lg:group-[.sidebar-collapsed]/container:ltr:pl-[85px] lg:rtl:pr-[286px] lg:group-[.sidebar-collapsed]/container:rtl:pr-[85px]">
                <!-- Added dynamic tabs for third level menus  -->
                <div class="pb-4 lg:pb-6">
                    <!-- Page Content Blade Component -->
                    <div class="kb-admin-panel w-full overflow-x-hidden p-4 sm:p-5">
                        {{ $slot }}
                    </div>
                </div>
                ...
                <!-- Powered By -->
                <div class="mt-auto">
                    <div class="kb-admin-panel border-t py-2 text-center text-xs sm:text-sm">
