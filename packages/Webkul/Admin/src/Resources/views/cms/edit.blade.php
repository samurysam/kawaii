            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group class="!mb-0">
                        ...
                        <p class="mb-3 text-sm text-[#8A6772]">
                            Paste full self-contained HTML here. Raw document markup is preserved for CMS pages, including
                        ...
                        <x-admin::form.control-group.control
                            type="textarea"
                            class="min-h-[520px] font-mono text-[13px] leading-6"
                            id="content"
