...
return [
    ...
    [
        ...
        'key' => 'sales.payment_methods.utap',
        'name' => 'admin::app.configuration.index.sales.payment-methods.utap',
        'info' => 'admin::app.configuration.index.sales.payment-methods.utap-info',
        'sort' => 10,
        'fields' => [
            [
                'name' => 'active',
                ...
                'name' => 'client_code',
                'title' => 'admin::app.configuration.index.sales.payment-methods.utap-client-code',
                'info' => 'admin::app.configuration.index.sales.payment-methods.utap-client-code-info',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
                ...
                'name' => 'user_name',
                'title' => 'admin::app.configuration.index.sales.payment-methods.utap-user-name',
                'info' => 'admin::app.configuration.index.sales.payment-methods.utap-user-name-info',
                'type' => 'password',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'user_pwd',
                'title' => 'admin::app.configuration.index.sales.payment-methods.utap-user-pwd',
                'info' => 'admin::app.configuration.index.sales.payment-methods.utap-user-pwd-info',
                'type' => 'password',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1',
                'channel_based' => true,
                ...
                'name' => 'cust_code',
                'title' => 'admin::app.configuration.index.sales.payment-methods.utap-cust-code',
                'info' => 'admin::app.configuration.index.sales.payment-methods.utap-cust-code-info',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'cust_group_cust_code',
                'title' => 'admin::app.configuration.index.sales.payment-methods.utap-cust-group-cust-code',
                'info' => 'admin::app.configuration.index.sales.payment-methods.utap-cust-group-cust-code-info',
                'type' => 'password',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
                ...
                'name' => 'ref_id',
                'title' => 'admin::app.configuration.index.sales.payment-methods.utap-ref-id',
                'info' => 'admin::app.configuration.index.sales.payment-methods.utap-ref-id-info',
                'type' => 'text',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
                ...
                'name' => 'link_validity',
                'title' => 'admin::app.configuration.index.sales.payment-methods.utap-link-validity',
                'info' => 'admin::app.configuration.index.sales.payment-methods.utap-link-validity-info',
                'type' => 'number',
                'depends' => 'active:1',
                'validation' => 'required_if:active,1|integer|min:1|max:1440',
                'channel_based' => true,
                'locale_based' => false,
            ], [
                'name' => 'accepted_currencies',
                ...
                'name' => 'sandbox',
                'title' => 'admin::app.configuration.index.sales.payment-methods.sandbox',
                'info' => 'admin::app.configuration.index.sales.payment-methods.utap-sandbox-info',
                'type' => 'boolean',
                'depends' => 'active:1',
                'channel_based' => true,
                'locale_based' => false,
