...
<x-shop::layouts>
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="kb-category-layout container px-[60px] max-lg:px-8 max-md:px-4">
                <div class="flex items-start gap-10 max-lg:gap-5 md:mt-10">
                    ...
                    <div class="flex-1">
                        ...
                        <div v-else class="mt-8 max-md:mt-5">
                            <!-- Product Card Shimmer Effect -->
                            <template v-if="isLoading">
                                <div class="grid grid-cols-3 gap-10 max-1060:grid-cols-2 max-md:justify-items-center max-md:gap-x-4">
