        ...
        <div>
            ...
            <div class="flex items-center justify-between max-md:hidden">
                ...
                >
                    <x-slot:toggle>
                        <!-- Dropdown Toggler -->
                        <button class="kb-toolbar-button flex w-full min-w-[220px] cursor-pointer items-center justify-between gap-4 p-4 text-base transition-all max-md:w-[110px] max-md:border-0 max-md:pl-2.5 max-md:pr-2.5">
                            @{{ sortLabel ?? "@lang('shop::app.products.sort-by.title')" }}

                            <span
                                class="icon-arrow-down text-2xl text-[#8A6772]"
                                role="presentation"
                            ></span>
                        </button>
                    </x-slot>
                    ...
                    <x-slot:menu>
                        <x-shop::dropdown.menu.item
                            ...
                            ::class="{'bg-[#FFF6FA] text-[#ED6E98]': sort.value == filters.applied.sort}"
                ...
                <div class="kb-toolbar-shell flex items-center gap-6 px-4 py-3">
                    <!-- Product Pagination Limit -->
                    <x-shop::dropdown position="bottom-right">
                        <x-slot:toggle>
                            <!-- Dropdown Toggler -->
                            <button class="kb-toolbar-button flex w-full min-w-[110px] cursor-pointer items-center justify-between gap-4 px-5 py-4 text-base transition-all max-md:w-[110px] max-md:border-0 max-md:pl-2.5 max-md:pr-2.5">
                        ...
                        <x-slot:menu>
                            <x-shop::dropdown.menu.item
                                ...
                                ::class="{'bg-[#FFF6FA] text-[#ED6E98]': limit == filters.applied.limit}"
                    ...
                    <div class="flex items-center gap-3 rounded-full border border-[#F8D9E4] bg-white/80 px-4 py-3">
                        <span
                            class="cursor-pointer rounded-full p-2 text-2xl transition"
                            role="button"
                            aria-label="@lang('shop::app.categories.toolbar.list')"
                            tabindex="0"
                            :class="(filters.applied.mode === 'list') ? 'icon-listing-fill bg-[#FFF6FA] text-[#ED6E98]' : 'icon-listing text-[#8A6772]'"
                        ...
                        <span
                            ...
                            tabindex="0"
                            :class="(filters.applied.mode === 'grid') ? 'icon-grid-view-fill bg-[#FFF6FA] text-[#ED6E98]' : 'icon-grid-view text-[#8A6772]'"
