<x-shop::layouts.account>
    ...
    <div class="kb-account-card flex-auto mx-4 max-md:mx-0">
        <div class="flex items-center justify-between border-b border-[#fae8ef] pb-6 mb-6">
            <div class="flex items-center gap-3">
                <a
                    class="grid md:hidden h-9 w-9 place-content-center rounded-full bg-[#fff4f8] text-[#ed6e98]"
                    href="{{ route('shop.customers.account.orders.view', $order->id) }}"
                >
                    <span class="text-xl icon-arrow-left rtl:icon-arrow-right"></span>
                </a>

                <h2 class="font-['Fredoka'] text-2xl font-bold text-[#382229] max-md:text-xl">
