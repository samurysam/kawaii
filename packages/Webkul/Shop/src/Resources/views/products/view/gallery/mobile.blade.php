<div
    ...
    v-if="isMediaLoading"
>
    <div class="kb-product-main-media shimmer aspect-square max-h-screen w-screen bg-zinc-200"></div>
</div>
...
@pushOnce('scripts')
    ...
    >
        <div class="relative m-auto flex w-full overflow-hidden">
            ...
            >
                <div
                    class="kb-product-main-media grid max-h-screen w-screen content-center bg-cover bg-no-repeat"
