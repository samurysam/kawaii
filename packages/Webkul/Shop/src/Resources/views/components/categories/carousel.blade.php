                    ...
                    >
                        ...
                        >
                            <x-shop::media.images.lazy
                                ::src="category.logo?.medium_image_url || category.logo?.large_image_url || category.logo?.original_image_url || fallback"
                                ::srcset="`
                                    ${(category.logo?.small_image_url || fallback)} 100w,
                                    ${(category.logo?.medium_image_url || fallback)} 300w,
                                    ${(category.logo?.large_image_url || fallback)} 600w,
                                    ${(category.logo?.original_image_url || fallback)} 1000w
                                `"
                                sizes="(max-width: 640px) 120px, 220px"
                                width="110"
                                height="110"
                                class="w-full rounded-full object-cover max-sm:h-[60px] max-sm:w-[60px]"
                                ::alt="category.name"
                            />
                        </a>
