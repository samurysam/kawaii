<x-shop::layouts>
    ...
    @pushOnce('scripts')
        ...
        >
            ...
            <div class="container mt-8 pb-12 max-1180:px-5 max-md:mt-6 max-md:px-4">
                <div class="m-auto w-full max-w-[870px] rounded-[28px] border-[1.5px] border-[#f6dce5] bg-white p-10 shadow-[0_14px_36px_rgba(237,110,152,0.08)] max-md:p-6">
                    <!-- Header -->
                    <div class="flex items-center justify-between gap-4 border-b border-[#fae8ef] pb-6 max-sm:flex-wrap">
                        <div class="flex items-center gap-2.5">
                            <span class="text-2xl">🍪</span>
                            <h1 class="font-['Fredoka'] text-2xl font-bold text-[#382229]">
                                @lang('shop::app.components.layouts.cookie.consent.your-cookie-consent-preferences')
                            </h1>
                        </div>
